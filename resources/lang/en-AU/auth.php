...
return [
    ...
    'invitation' => [
        'message_1'         => 'You are receiving this email because you are invited to join the NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Customise your NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'They get full access to your NuvisAccounting including customers, invoices, reports, settings, and apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'They get full access to your NuvisAccounting, but can\'t manage users and apps.',
        ],
        'customer' => [
            'name'          => 'Customer',
