...
return [
    ...
    'notifications' => [
        ...
        'overdue_invoices'  => '{1} :count achterstallige factuur|[2,*] :count achterstallige facturen',
        'upcoming_bills'    => '{1} :count aankomende inkoopfactuur|[2,*] :count aankomende inkoopfacturen',
        ...
        'imports' => [
            ...
            'failed' => '{1} :count mislukte import|[2,*] :count mislukte imports',
        ],
    ],
