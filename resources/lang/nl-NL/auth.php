...
return [
    ...
    'invitation' => [
        'message_1'         => 'U ontvangt deze e-mail omdat u bent uitgenodigd om deel te nemen aan NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Uw NuvisAccounting Aanpassen',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Zij krijgen volledige toegang tot uw NuvisAccounting inclusief klanten, facturen, rapporten, instellingen en apps.',
        ],
        'manager' => [
            'name'          => 'Beheerder',
            'description'   => 'Zij krijgen volledige toegang tot je NuvisAccounting, maar kunnen geen gebruikers en apps beheren.',
        ],
        'customer' => [
            'name'          => 'Klant',
