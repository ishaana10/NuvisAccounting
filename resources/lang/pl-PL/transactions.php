...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Ten punkt końcowy nie może zostać dodany do dokumentu. Użyj {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'Ten punkt końcowy nie może zostać zaktualizowany dla dokumentu. Użyj {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'Ten punkt końcowy nie może zostać usunięty z dokumentu. Użyj {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ]
