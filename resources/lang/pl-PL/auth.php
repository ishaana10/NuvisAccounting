...
return [
    ...
    'invitation' => [
        'message_1'         => 'Otrzymujesz tę wiadomość, ponieważ zostałeś zaproszony do dołączenia do NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Dostosuj swój NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrator',
            'description'   => 'Ma pełny dostęp do Twojego NuvisAccounting, w tym klientów, faktur, raportów, ustawień i aplikacji.',
        ],
        'manager' => [
            'name'          => 'Menedżer',
            'description'   => 'Ma pełny dostęp do Twojego NuvisAccounting, ale nie może zarządzać użytkownikami i aplikacjami.',
        ],
        'customer' => [
            'name'          => 'Klient',
