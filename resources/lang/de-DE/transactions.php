...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Dieser Endpunkt kann nicht zu einem Dokument hinzugefügt werden. Verwenden Sie {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'Dieser Endpunkt kann nicht für ein Dokument aktualisiert werden. Verwenden Sie {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'Dieser Endpunkt kann nicht für ein Dokument gelöscht werden. Verwenden Sie {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ]
