...
return [
    ...
    'requirements' => [
        ...
        'npm'               => '<b>JavaScript-Dateien fehlen!</b> <br><br><span>Sie sollten die Befehle <em class="underline">npm install</em> und <em class="underline">npm run dev</em> ausführen.</span>',
    ],
    ...
    'update' => [
        'core'              => 'Eine neue Version von NuvisAccounting ist verfügbar! Bitte aktualisieren Sie <a href=":url">Ihre Installation</a>.',
        'module'            => 'Eine neue Version von :module ist verfügbar! Bitte aktualisieren Sie <a href=":url">Ihre Installation</a>.',
    ],
];
