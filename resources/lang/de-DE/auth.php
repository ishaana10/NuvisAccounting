...
return [
    ...
    'invitation' => [
        'message_1'         => 'Sie erhalten diese E-Mail, weil Sie zur Mitarbeit bei NuvisAccounting eingeladen wurden.',
    ...
    'information' => [
        ...
        'customize'         => 'Passen Sie Ihr NuvisAccounting an',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Er erhält vollen Zugriff auf NuvisAccounting, einschließlich Kunden, Rechnungen, Berichte, Einstellungen und Apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'Er erhält vollen Zugriff auf NuvisAccounting, kann aber keine Benutzer und Apps verwalten.',
        ],
        'customer' => [
            'name'          => 'Kunde',
