...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Este endpoint não pode ser adicionado a um documento. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'Este endpoint não pode ser atualizado para um documento. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'Este endpoint não pode ser excluído de um documento. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ],
