...
return [
    ...
    'invitation' => [
        'message_1'         => 'Você está recebendo este e-mail porque foi convidado a juntar-se ao NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalize seu NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrador',
            'description'   => 'Eles têm acesso total ao seu NuvisAccounting, incluindo clientes, faturas, relatórios, configurações e apps.',
        ],
        'manager' => [
            'name'          => 'Gerente',
            'description'   => 'Eles têm acesso total ao seu NuvisAccounting, mas não podem gerenciar usuários e apps.',
        ],
        'customer' => [
            'name'          => 'Cliente',
