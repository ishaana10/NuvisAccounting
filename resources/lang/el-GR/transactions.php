...
return [
    ...
    'related_bill'          => 'Σχετικό Τιμολόγιο Αγοράς',
    ...
    'form_description' => [
        ...
        'other'             => 'Εισαγάγετε αριθμό και αναφορά για να διατηρήσετε τη συναλλαγή συνδεδεμένη με τα αρχεία σας.',
    ],
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Αυτό το τελικό σημείο δεν μπορεί να προστεθεί σε έγγραφο. Χρησιμοποιήστε {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'Αυτό το τελικό σημείο δεν μπορεί να ενημερωθεί σε έγγραφο. Χρησιμοποιήστε {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'Αυτό το τελικό σημείο δεν μπορεί να διαγραφεί από έγγραφο. Χρησιμοποιήστε {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ]
