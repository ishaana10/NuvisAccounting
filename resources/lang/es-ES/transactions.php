...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'No se puede añadir este endpoint a un documento. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'No se puede actualizar este endpoint en un documento. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'No se puede eliminar este endpoint de un documento. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ],
