...
return [
    ...
    'invitation' => [
        'message_1'         => 'Ha recibido este correo electrónico porque se le ha invitado a unirse a NuvisAccounting.',
    ...
    'roles' => [
        'admin' => [
            'name'          => 'Administrador',
            'description'   => 'Tienen acceso completo a NuvisAccounting, incluidos clientes, facturas, informes, configuración y aplicaciones.',
        ],
        'manager' => [
            'name'          => 'Gestor',
            'description'   => 'Tienen acceso completo a NuvisAccounting, pero no pueden gestionar usuarios ni aplicaciones.',
        ],
        'customer' => [
            'name'          => 'Cliente',
