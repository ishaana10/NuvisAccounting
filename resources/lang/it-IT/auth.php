...
return [
    ...
    'invitation' => [
        'message_1'         => 'Hai ricevuto questa email perché sei stato invitato a partecipare ad NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalizza il tuo NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Amministratore',
            'description'   => 'Hanno pieno accesso al tuo NuvisAccounting inclusi clienti, fatture, report, impostazioni e app.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'Hanno accesso completo al tuo NuvisAccounting, ma non possono gestire utenti e app.',
        ],
        'customer' => [
            'name'          => 'Cliente',
