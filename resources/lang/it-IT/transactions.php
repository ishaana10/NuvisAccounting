...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Questo endpoint non può essere aggiunto a un documento. Usa {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'Questo endpoint non può essere aggiornato per un documento. Usa {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'Questo endpoint non può essere eliminato per un documento. Usa {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ]
