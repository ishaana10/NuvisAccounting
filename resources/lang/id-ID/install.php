...
return [
    ...
    'error' => [
        'php_version'       => 'Kesalahan: Minta ke penyedia hosting Anda untuk menggunakan PHP :php_version atau lebih tinggi untuk HTTP dan CLI.',
        'connection'        => 'Kesalahan: Tidak dapat terhubung ke database! Silakan, pastikan bahwa rinciannya benar.',
    ],

    'update' => [
        'core'              => 'Versi baru NuvisAccounting tersedia! Harap perbarui <a href=":url">pemasangan Anda.</a>',
