...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Titik akhir ini tidak dapat ditambahkan ke dokumen. Gunakan {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'Titik akhir ini tidak dapat diperbarui ke dokumen. Gunakan {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'Titik akhir ini tidak dapat dihapus dari dokumen. Gunakan {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ],
