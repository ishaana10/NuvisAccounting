...
return [
    ...
    'invitation' => [
        'message_1'         => 'Anda menerima email ini karena Anda diundang untuk bergabung ke NuvisAccounting.',
    ...
    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Mereka memiliki akses penuh ke NuvisAccounting termasuk pelanggan, faktur, laporan, pengaturan, dan aplikasi.',
        ],
        'manager' => [
            'name'          => 'Manajer',
            'description'   => 'Mereka mendapat akses penuh ke NuvisAccounting, tapi tidak bisa mengelola pengguna dan aplikasi.',
        ],
        'customer' => [
            'name'          => 'Pelanggan',
