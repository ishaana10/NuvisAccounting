...
return [
    ...
    'invitation' => [
        'message_1'         => 'Estàs rebent aquest correu electrònic perquè estàs convidat a unir-te a l\'NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalitza el teu NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrador',
            'description'   => 'Tenen accés complet al vostre NuvisAccounting, inclosos clients, factures, informes, configuracions i aplicacions.',
        ],
        'manager' => [
            'name'          => 'Gerent',
            'description'   => 'Tenen accés complet al teu NuvisAccounting, però no poden gestionar usuaris i aplicacions.',
        ],
        'customer' => [
            'name'          => 'Client',
