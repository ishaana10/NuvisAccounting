...
return [
    ...
    'invitation' => [
        'message_1'         => 'Primili ste ovaj email jer ste pozvani da se pridružite NuvisAccountingu.',
    ...
    'information' => [
        ...
        'customize'         => 'Prilagodite svoj NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Oni dobijaju potpuni pristup vašem NuvisAccounting-u uključujući klijente, fakture, izvještaje, postavke i aplikacije.',
        ],
        'manager' => [
            'name'          => 'Upravljaj',
            'description'   => 'Oni imaju potpuni pristup vašem NuvisAccountingu, ali ne mogu upravljati korisnicima i aplikacijama.',
        ],
        'customer' => [
            'name'          => 'Kupci',
