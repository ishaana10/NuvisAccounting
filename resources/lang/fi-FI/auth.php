...
return [
    ...
    'invitation' => [
        'message_1'         => 'Sait tämän viestin koska sinut on kutsuttu mukaan käyttämään NuvisAccounting:ia ',
    ...
    'information' => [
        ...
        'customize'         => 'Luo omanlainen NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Ylläpitäjä',
            'description'   => 'He saavat täydet oikeudet kaikkiin NuvisAccounting:in palveluihin kuten asiakastietoihin, laskuihin, raportteihin, asetuksiin ja sovelluksiin
',
        ],
        'manager' => [
            'name'          => 'Valvoja',
            'description'   => 'He saavat täydet oikeudet NuvisAccounting:iin mutta ei voi hallinnoida käyttäjiä tai sovelluksia
',
        ],
        'customer' => [
            'name'          => 'Asiakas',
