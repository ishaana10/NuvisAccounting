...
return [
    ...
    'invitation' => [
        'message_1'         => 'Ha recibido este correo electrónico porque está invitado a unirse a NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalice su NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrador',
            'description'   => 'Obtendrán acceso total a NuvisAccounting, incluyendo clientes, facturas, reportes, configuraciones y aplicaciones.',
        ],
        'manager' => [
            'name'          => 'Gerente',
            'description'   => 'Obtendrán acceso total a NuvisAccounting, pero no pueden administrar usuarios ni aplicaciones.',
        ],
        'customer' => [
            'name'          => 'Cliente',
