...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Este endpoint no puede ser añadido a un documento. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'Este endpoint no puede ser actualizado para un documento. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'Este endpoint no puede ser eliminado de un documento. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ],
