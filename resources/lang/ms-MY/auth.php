...
return [
    ...
    'invitation' => [
        'message_1'         => 'Anda menerima e-mel ini kerana anda dijemput untuk menyertai NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Sesuaikan NuvisAccounting Anda',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Pentadbir',
            'description'   => 'Mereka mendapat akses penuh ke NuvisAccounting anda termasuk pelanggan, invois, laporan, tetapan, dan aplikasi.',
        ],
        'manager' => [
            'name'          => 'Pengurus',
            'description'   => 'Mereka mendapat akses penuh ke NuvisAccounting anda, tetapi tidak boleh mengurus pengguna dan aplikasi.',
        ],
        'customer' => [
            'name'          => 'Pelanggan',
