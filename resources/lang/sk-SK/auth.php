...
return [
    ...
    'invitation' => [
        'message_1'         => 'Tento e-mail ste dostali, pretože ste pozvaní do NuvisAccountingu.',
    ...
    'information' => [
        ...
        'customize'         => 'Prispôsobte si svoj NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrátor',
            'description'   => 'Získajú úplný prístup k vášmu NuvisAccountingu vrátane zákazníkov, faktúr, prehľadov, nastavení a aplikácií.',
        ],
        'manager' => [
            'name'          => 'Manažér',
            'description'   => 'Získajú úplný prístup k vášmu NuvisAccountingu, ale nemôžu spravovať používateľov a aplikácie.',
        ],
        'customer' => [
            'name'          => 'Zákazník',
