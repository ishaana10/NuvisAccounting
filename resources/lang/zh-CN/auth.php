...
return [
    ...
    'invitation' => [
        'message_1'         => '您收到此邮件是因为您被邀请加入 NuvisAccounting。',
    ...
    'information' => [
        ...
        'reports'           => '获取详细报表',
        'expense'           => '跟踪任何支出',
        'customize'         => '自定义您的 NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => '管理员',
            'description'   => '他们可以完全访问您的 NuvisAccounting，包括客户、发票、报表、设置和应用。',
        ],
        'manager' => [
            'name'          => '经理',
            'description'   => '他们可以完全访问您的 NuvisAccounting，但无法管理用户和应用。',
        ],
        'customer' => [
            'name'          => '客户',
