...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => '此端点无法添加到文档。请使用 {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => '此端点无法更新到文档。请使用 {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => '此端点无法从文档删除。请使用 {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ]
