...
return [
    ...
    'invitation' => [
        'message_1'         => 'Du får detta e-postmeddelande eftersom du är inbjuden att gå med i NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Anpassa NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administratör',
            'description'   => 'De får full tillgång till din NuvisAccounting inklusive kunder, fakturor, rapporter, inställningar och appar.',
        ],
        'manager' => [
            'name'          => 'Föreståndare',
            'description'   => 'De får full tillgång till din NuvisAccounting, men kan inte hantera användare och appar.',
        ],
        'customer' => [
            'name'          => 'Kund',
