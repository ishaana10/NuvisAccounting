...
return [
    ...
    'error' => [
        ...
        'unassigned'        => 'Грешка: Не може да се одвои компанијата! На :company компанијата мора да ѝ се додели најмалку еден корисник.',
    ...
    'invitation' => [
        'message_1'         => 'Ја добивате оваа е-пошта затоа што сте поканети да се придружите на NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Прилагодете го вашиот NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Админ',
            'description'   => 'Тие добиваат целосен пристап до вашиот NuvisAccounting вклучувајќи клиенти, фактури, извештаи, поставки и апликации.',
        ],
        'manager' => [
            'name'          => 'Менаџер',
            'description'   => 'Тие добиваат целосен пристап до вашиот NuvisAccounting, но не можат да управуваат со корисници и апликации.',
        ],
        'customer' => [
            'name'          => 'Клиент',
