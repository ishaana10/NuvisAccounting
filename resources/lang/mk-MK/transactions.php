...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Оваа крајна точка не може да се додаде во документ. Користете {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'Оваа крајна точка не може да се ажурира во документ. Користете {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'Оваа крајна точка не може да се избрише од документ. Користете {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ]
