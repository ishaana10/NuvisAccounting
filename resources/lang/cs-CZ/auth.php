...
return [
    ...
    'invitation' => [
        'message_1'         => 'Obdrželi jste tento e-mail, protože jste pozváni do NuvisAccountingu.',
    ...
    'roles' => [
        ...
        'manager' => [
            'name'          => 'Správce',
            'description'   => 'Mají plný přístup k Vašemu NuvisAccountingu, ale nemohou spravovat uživatele a aplikace.',
        ],
        'customer' => [
            'name'          => 'Zákazník',
