...
return [
    ...
    'invitation' => [
        'message_1'         => 'Vous recevez cet e-mail parce que vous êtes invité à rejoindre NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Personnaliser votre NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrateur',
            'description'   => 'Ils obtiennent un accès complet à votre NuvisAccounting, y compris vos clients, factures, rapports, paramètres et applications.',
        ],
        'manager' => [
            'name'          => 'Gérant',
            'description'   => 'Ils ont un accès complet à votre NuvisAccounting, mais ne peuvent pas gérer les utilisateurs et les applications.',
        ],
        'customer' => [
            'name'          => 'Client',
