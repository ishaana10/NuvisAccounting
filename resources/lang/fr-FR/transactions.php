...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Ce point de terminaison ne peut pas être ajouté à un document. Utilisez {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'Ce point de terminaison ne peut pas être mis à jour pour un document. Utilisez {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'Ce point de terminaison ne peut pas être supprimé d\'un document. Utilisez {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ],
