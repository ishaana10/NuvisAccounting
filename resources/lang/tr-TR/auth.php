...
return [
    ...
    'invitation' => [
        'message_1'         => 'NuvisAccounting\'e katılmaya davet edildiğiniz için bu e-postayı alıyorsunuz.',
    ...
    'information' => [
        ...
        'customize'         => 'NuvisAccounting\'inizi kişiselleştirin',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Yönetici',
            'description'   => 'Müşteriler, faturalar, raporlar, ayarlar ve uygulamalar dahil olmak üzere NuvisAccounting\'inize tam erişim elde ederler.',
        ],
        'manager' => [
            'name'          => 'Müdür',
            'description'   => 'NuvisAccounting\'inize tam erişime sahip olurlar, ancak kullanıcıları ve uygulamaları yönetemezler.',
        ],
        'customer' => [
            'name'          => 'Müşteri',
