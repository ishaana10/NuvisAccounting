...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Bu uç nokta bir belgeye eklenemez. {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions kullanın',
        'update_document_transaction_error' => 'Bu uç nokta bir belgeye güncellenemez. {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id} kullanın',
        'delete_document_transaction_error' => 'Bu uç nokta bir belgeden silinemez. {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id} kullanın',
    ],
