...
return [
    ...
    'invitation' => [
        'message_1'         => 'أنت تتلقى هذا البريد الإلكتروني لأنك مدعو للانضمام إلى NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'تخصيص NuvisAccounting الخاص بك',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'الإدارة',
            'description'   => 'يحصلون على الوصول الكامل إلى NuvisAccounting بما في ذلك العملاء، الفواتير، التقارير، الإعدادات، والتطبيقات.',
        ],
        'manager' => [
            'name'          => 'مدير',
            'description'   => 'يحصلون على الوصول الكامل إلى NuvisAccounting، ولكن لا يمكنهم إدارة المستخدمين والتطبيقات.',
        ],
        'customer' => [
            'name'          => 'عميل',
