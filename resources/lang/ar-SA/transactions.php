...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'لا يمكن إضافة نقطة النهاية هذه إلى مستند. استخدم {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'لا يمكن تحديث نقطة النهاية هذه لمستند. استخدم {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'لا يمكن حذف نقطة النهاية هذه من مستند. استخدم {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ]
