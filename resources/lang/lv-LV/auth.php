...
return [
    ...
    'invitation' => [
        'message_1'         => 'Jūs saņēmāt šo e-pasta ziņojumu, jo esat uzaicināts pievienoties NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Pielāgojiet savu NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrators',
            'description'   => 'Viņi iegūst pilnu piekļuvi jūsu NuvisAccounting, tostarp klientiem, rēķiniem, pārskatiem, iestatījumiem un lietotnēm.',
        ],
        'manager' => [
            'name'          => 'Vadītājs',
            'description'   => 'Viņi iegūst pilnu piekļuvi jūsu NuvisAccounting, taču nevar pārvaldīt lietotājus un lietotnes.',
        ],
        'customer' => [
            'name'          => 'Klients',
