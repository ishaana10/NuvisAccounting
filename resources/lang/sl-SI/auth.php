...
Napaka: ni mogoče preklicati podjetja! Podjetju :company mora biti dodeljen vsaj en uporabnik.',
    ...
    'invitation' => [
        'message_1'         => '
To e-pošto ste prejeli, ker ste vabljeni, da se pridružite Programu NuvisAccounting.',
...
Spremljajte kakršne koli stroške',
        'customize'         => '
Prilagodite svoj NuvisAccounting',
    ],
    ...
    'roles' => [
        ...
        'manager' => [
            'name'          => 'Upravitelj',
            'description'   => 'Dobijo popoln dostop do vašega NuvisAccountinga, vendar ne morejo upravljati uporabnikov in aplikacij.',
        ],
        'customer' => [
            'name'          => 'Stranka',
