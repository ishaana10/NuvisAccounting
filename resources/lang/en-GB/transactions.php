...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'This endpoint cannot be added to a document. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'This endpoint cannot be updated to a document. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'This endpoint cannot be deleted to a document. Use {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ]
