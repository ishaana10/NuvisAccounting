...
return [
    ...
    'invitation' => [
        'message_1'         => 'Получавате този имейл, защото сте поканени да се присъедините към NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Персонализирайте вашия NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Администратор',
            'description'   => 'Те получават пълен достъп до вашия NuvisAccounting, включително клиенти, фактури, отчети, настройки и приложения.',
        ],
        'manager' => [
            'name'          => 'Мениджър',
            'description'   => 'Те получават пълен достъп до вашия NuvisAccounting, но не могат да управляват потребители и приложения.',
        ],
        'customer' => [
            'name'          => 'Клиент',
