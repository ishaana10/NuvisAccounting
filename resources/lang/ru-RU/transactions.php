...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'Эта конечная точка не может быть добавлена к документу. Используйте {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions',
        'update_document_transaction_error' => 'Эта конечная точка не может быть обновлена для документа. Используйте {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
        'delete_document_transaction_error' => 'Эта конечная точка не может быть удалена для документа. Используйте {{nuvisaccounting_url}}/documents/{{nuvisaccounting_document_id}}/transactions/{nuvisaccounting_transaction_id}',
    ]
