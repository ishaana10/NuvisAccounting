...
return [
    ...
    'invitation' => [
        'message_1'         => 'Primești acest email deoarece ești invitat să te alături în NuvisAccounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalizează-ți NuvisAccounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrator',
            'description'   => 'Aceștia au acces deplin la NuvisAccounting-ul tău, inclusiv la clienți, facturi, rapoarte, setări și aplicații.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'Obțin acces deplin la NuvisAccountingul tău, dar nu pot gestiona utilizatorii și aplicațiile.',
        ],
        'customer' => [
            'name'          => 'Client',
