                                                ...
                                                <tbody>
                                                    ...
                                                    <tr :id="'addItem-' + _uid">
                                                        <td colspan="3" class="w-12/12 p-0">
                                                            <nuvisaccounting-document-button
                                                                :items="documents"
...
import NuvisAccountingDocumentButton from './NuvisAccountingDocumentButton';
import {Money} from 'v-money';

export default {
    name: 'nuvisaccounting-connect-transactions',
