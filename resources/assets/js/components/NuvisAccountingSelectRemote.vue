...
import NuvisAccountingModalAddNew from './NuvisAccountingModalAddNew';
import NuvisAccountingModal from './NuvisAccountingModal';
import NuvisAccountingMoney from './NuvisAccountingMoney';
import NuvisAccountingRadioGroup from './NuvisAccountingRadioGroup';
import NuvisAccountingSelect from './NuvisAccountingSelect';
import NuvisAccountingDate from './NuvisAccountingDate';
import NuvisAccountingRecurring from './NuvisAccountingRecurring';

import Form from './../plugins/form';

export default {
    name: "nuvisaccounting-select-remote",
        ...
        onModal(value) {
            ...
            .then(response => {
                ...
                this.add_new_html = Vue.component('add-new-component', function (resolve, reject) {
                    resolve({
                        template: '<div><nuvisaccounting-modal-add-new modal-dialog-class="max-w-md" modal-position-top :show="add_new.show" @submit="onSubmit" @cancel="onCancel" :buttons="add_new.buttons" :title="add_new.text" :is_component=true :message="add_new.html"></nuvisaccounting-modal-add-new></div>',
