...
export default {
    name: 'nuvisaccounting-company-edit',
        ...
        onEditCompany() {
            ...
            .then(response => {
                ...
                this.company_html = Vue.component('add-new-component', function (resolve, reject) {
                    resolve({
                        template: '<div><nuvisaccounting-modal-add-new :show="company_form.show" @submit="onSubmit" @cancel="onCancel" :buttons="company_form.buttons" :title="company_form.text" :is_component=true :message="company_form.html"></nuvisaccounting-modal-add-new></div>',
