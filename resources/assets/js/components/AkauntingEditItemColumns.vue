...
export default {
  name: 'nuvisaccounting-edit-item-columns',
    ...
    onEditItemColumns() {
      ...
      .then(response => {
          ...
          this.edit_html = Vue.component('add-new-component', function (resolve, reject) {
              resolve({
                  template: '<div><nuvisaccounting-modal-add-new :show="edit_column.show" @submit="onSubmit" @cancel="onCancel" :buttons="edit_column.buttons" :title="edit_column.text" :is_component=true :message="edit_column.html"></nuvisaccounting-modal-add-new></div>',
