                        ...
                        <div class="flex flex-col justify-between -mt-5 sm:mt-0">
                            <div class="grid sm:grid-cols-6 gap-x-8 gap-y-6 my-3.5 menu-scroll gap-10">
                                <div class="sm:col-span-6 -mt-2">
                                    ...
                                    <div class="mt-2">
                                        <small>
                                            <a href="https://nuvisaccounting.com/dashboard" class="text-green" target="_blank">Click here</a>
                                                to get your API key.
                                        </small>
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-3 -mt-2">
                                    ...
                                    <nuvisaccounting-dropzone-file-upload ref="dropzoneWizard" class="form-file dropzone-column" style="width: 10.8rem; height: 10.8rem;" preview-classes="single" :attachments="logo" :v-model="logo">
                                    </nuvisaccounting-dropzone-file-upload>
