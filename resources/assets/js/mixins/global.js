...
import NuvisAccountingDropzoneFileUpload from './../components/NuvisAccountingDropzoneFileUpload';
import NuvisAccountingContactCard from './../components/NuvisAccountingContactCard';
import NuvisAccountingCompanyEdit from './../components/NuvisAccountingCompanyEdit';
import NuvisAccountingEditItemColumns from './../components/NuvisAccountingEditItemColumns';
import NuvisAccountingItemButton from './../components/NuvisAccountingItemButton';
import NuvisAccountingDocumentButton from './../components/NuvisAccountingDocumentButton';
import NuvisAccountingSearch from './../components/NuvisAccountingSearch';
import NuvisAccountingModal from './../components/NuvisAccountingModal';
import NuvisAccountingMoney from './../components/NuvisAccountingMoney';
import NuvisAccountingModalAddNew from './../components/NuvisAccountingModalAddNew';
import NuvisAccountingRadioGroup from './../components/NuvisAccountingRadioGroup';
import NuvisAccountingSelect from './../components/NuvisAccountingSelect';
import NuvisAccountingSelectRemote from './../components/NuvisAccountingSelectRemote';
import NuvisAccountingDate from './../components/NuvisAccountingDate';
import NuvisAccountingRecurring from './../components/NuvisAccountingRecurring';
import NuvisAccountingHtmlEditor from './../components/NuvisAccountingHtmlEditor';
import NuvisAccountingCountdown from './../components/NuvisAccountingCountdown';
import NuvisAccountingCurrencyConversion from './../components/NuvisAccountingCurrencyConversion';
import NuvisAccountingConnectTransactions from './../components/NuvisAccountingConnectTransactions';
import NuvisAccountingSwitch from './../components/NuvisAccountingSwitch';
import NuvisAccountingSlider from './../components/NuvisAccountingSlider';
import NuvisAccountingColor from './../components/NuvisAccountingColor';
import NuvisAccountingImport from './../components/NuvisAccountingImport';
...
export default {
    components: {
        NuvisAccountingDropzoneFileUpload,
        NuvisAccountingContactCard,
        NuvisAccountingCompanyEdit,
        NuvisAccountingEditItemColumns,
        NuvisAccountingItemButton,
        NuvisAccountingDocumentButton,
        NuvisAccountingSearch,
        NuvisAccountingRadioGroup,
        NuvisAccountingSelect,
        NuvisAccountingSelectRemote,
        NuvisAccountingMoney,
        NuvisAccountingModal,
        NuvisAccountingModalAddNew,
        NuvisAccountingDate,
        NuvisAccountingRecurring,
        NuvisAccountingHtmlEditor,
        NuvisAccountingCountdown,
        NuvisAccountingCurrencyConversion,
        NuvisAccountingConnectTransactions,
        NuvisAccountingSwitch,
        NuvisAccountingSlider,
        NuvisAccountingColor,
        NuvisAccountingImport,
        CardForm,
        [Select.name]: Select,
        [Option.name]: Option,
        [Steps.name]: Steps,
    ...
    methods: {
        ...
        confirmDelete(url, title, message, button_cancel, button_delete) {
            ...
            this.component = Vue.component('add-new-component', (resolve, reject) => {
                resolve({
                    template : '<div id="dynamic-delete-component"><nuvisaccounting-modal v-if="confirm.show" :show="confirm.show" :title="confirm.title" :message="confirm.message" :button_cancel="confirm.button_cancel" :button_delete="confirm.button_delete" @confirm="onDelete" @cancel="cancelDelete"></nuvisaccounting-modal></div>',
        ...
        onDynamicComponentWithParams(modal) {
            this.component = Vue.component('add-new-component', (resolve, reject) => {
                resolve({
                    template: '<div id="dynamic-payment-component"><nuvisaccounting-modal-add-new :show="modal.modal" @submit="onSubmit" @cancel="onCancel" :buttons="modal.buttons" :title="modal.title" :is_component=true :message="modal.html"></nuvisaccounting-modal-add-new></div>',
        ...
        onDeleteFile(file_id, url, title, message, button_cancel, button_delete) {
            ...
            this.component = Vue.component('add-new-component', (resolve, reject) => {
                resolve({
                    template : '<div id="dynamic-delete-file-component"><nuvisaccounting-modal v-if="confirm.show" :show="confirm.show" :title="confirm.title" :message="confirm.message" :button_cancel="confirm.button_cancel" :button_delete="confirm.button_delete" @confirm="onDelete" @cancel="cancelDelete"></nuvisaccounting-modal></div>',
        ...
        async onAddPayment(url) {
            ...
            payment_promise.then(response => {
                ...
                this.component = Vue.component('add-new-component', (resolve, reject) => {
                    resolve({
                        template: '<div id="dynamic-payment-component"><nuvisaccounting-modal-add-new modal-dialog-class="max-w-md" modal-position-top :show="payment.modal" @submit="onSubmit" @submitViaSendEmail="onSubmitViaSendEmail" @cancel="onCancel" :buttons="payment.buttons" :title="payment.title" :is_component=true :message="payment.html"></nuvisaccounting-modal-add-new></div>',
        ...
        async onEditPayment(url) {
            ...
            payment_promise.then(response => {
                ...
                this.component = Vue.component('add-new-component', (resolve, reject) => {
                    resolve({
                        template: '<div id="dynamic-payment-component"><nuvisaccounting-modal-add-new modal-dialog-class="max-w-md" modal-position-top :show="payment.modal" @submit="onSubmit" @cancel="onCancel" :buttons="payment.buttons" :title="payment.title" :is_component=true :message="payment.html"></nuvisaccounting-modal-add-new></div>',
        ...
        async onSendEmail(url) {
            ...
            email_promise.then(response => {
                ...
                this.component = Vue.component('add-new-component', (resolve, reject) => {
                    resolve({
                        template: '<div id="dynamic-email-component"><nuvisaccounting-modal-add-new modal-dialog-class="max-w-screen-md" modal-position-top :show="email.modal" @submit="onSubmit" @cancel="onCancel" :buttons="email.buttons" :title="email.title" :is_component=true :message="email.html"></nuvisaccounting-modal-add-new></div>',
        ...
        onShareLink(url) {
            ...
            share_promise.then(response => {
                ...
                this.component = Vue.component('add-new-component', (resolve, reject) => {
                    resolve({
                        template: '<div id="dynamic-share-component"><nuvisaccounting-modal-add-new modal-dialog-class="max-w-screen-md" :show="share.modal" @submit="onCopyLink" @cancel="onCancel" :buttons="share.buttons" :is_component=true :title="share.title" :message="share.html"></nuvisaccounting-modal-add-new></div>',
        ...
        onModalAddNew(url) {
            ...
            .then(response => {
                if (response.data.success) {
                    ...
                    this.component = Vue.component('add-new-component', (resolve, reject) => {
                        resolve({
                            template: '<div id="dynamic-add-new-modal-component"><nuvisaccounting-modal-add-new modal-dialog-class="max-w-md" :show="modal.show" :buttons="modal.buttons" :title="modal.title" :message="modal.html" :is_component=true @submit="onSubmit" @cancel="onCancel"></nuvisaccounting-modal-add-new></div>',
