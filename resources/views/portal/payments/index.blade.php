        ...
        @else
            <div class="flex">
                <div class="w-full text-center">
                    ...
                    <div class="my-10">
                        <x-link
                            href="https://nuvisaccounting.com/accounting-software?utm_source=software&utm_medium=payment_index&utm_campaign=plg"
                    ...
                    <div class="my-10">
                        <img src="https://assets.nuvisaccounting.com/software/portal/payment.gif" class="inline" alt="Get Started" />
                    </div>
                </div>
            </div>
