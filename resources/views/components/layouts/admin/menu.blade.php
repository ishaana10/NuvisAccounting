...
<div class="container flex items-center py-3 mb-4 border-b-2 xl:hidden">
    ...
    <div class="flex items-center m-auto">
        <img src="{{ asset('public/img/nuvisaccounting-logo-green.svg') }}" class="w-8 m-auto" alt="NuvisAccounting" />
        ...
        <div class="relative mb-5 cursor-pointer">
            <button type="button" class="flex items-center" data-dropdown-toggle="dropdown-menu-company">
                <div class="w-8 h-8 flex items-center justify-center">
                    <img src="{{ asset('public/img/nuvisaccounting-logo-green.svg') }}" class="w-6 h-6" alt="NuvisAccounting" />
                </div>
            ...
            <div id="dropdown-menu-company" class="absolute ltr:right-0 rtl:left-0 mt-3 pt-2 bg-white rounded-md shadow-xl z-20 hidden" style="{{ language()->direction() === 'rtl' ? 'right: auto;' : 'left: auto;' }} min-width: 10rem;">
