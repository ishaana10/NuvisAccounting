...
@else
    <div class="w-full lg:h-48 px-6 bg-dark-blue rounded-lg flex flex-col lg:flex-row justify-between items-center my-8">
        <div class="w-full lg:w-1/2 flex flex-col self-end py-6">
            ...
            <x-link href="https://nuvisaccounting.com/plans-on-premise" target="_blank" class="text-white transition-all hover:underline" override="class">
                {{ trans('modules.learn_more') }}
            </x-link>
        </div>

        <div class="hidden lg:block">
            <img src="{{ asset('/public/img/nuvisaccounting-logo-gold.png') }}" class="h-40" alt="NuvisAccounting" />
        </div>
    </div>
@endif
