...
use NuvisAccounting\Menu\Presenters\Presenter;
...
class Menu extends Presenter
{
    ...
    public function getMenuWithDropDownWrapper($item)
    {
        ...
        <details ' . $this->getActiveStateOnChild($item) . '>
            ...
            <div class="mt-2 ltr:ml-8 rtl:mr-8 menu__submenu" id="navbar-' . $id . '">
     ...
     *
     * @param \NuvisAccounting\Menu\MenuItem $item
     *
     * @return string`
     */
    public function getMultiLevelDropdownWrapper($item)
    {
        ...
        return '<details class="relative" ' . $this->getActiveStateOnChild($item) . '>
                    ...
                    <div class="mt-2 ltr:ml-8 rtl:mr-8 menu__submenu' . $this->getShowStateOnChild($item) . '" id="navbar-' . $id . '">
                        <ul class="relative pb-2.5">
                            ' . $this->getChildMenuItems($item) . '
                        </ul>
                    </div>
    ...
    protected function getCustomIcon($item)
    {
        ...
        if (! file_exists($path)) {
            $path = 'public/img/nuvisaccounting-logo-purple.svg';
        }
