...
trait Modules
{
    ...
    {
        if (! module($alias) instanceof \NuvisAccounting\Module\Module) {
            return false;
        }
    ...
    /**
     * Whether the app is part of how NuvisAccounting is expected to work, and so may
    ...
    public function loadSubscriptions()
    {
        ...
        return Cache::remember($key, Date::now()->addHours(6), function () {
            ...
            if (! is_cloud()) {
                $data['headers'] = [
                    'X-NuvisAccounting-Modules' => implode(',', module()->getAvailable()),
                ];
            }
    ...
    {
        app(\NuvisAccounting\Module\Contracts\ActivatorInterface::class)->register();
    }
}
