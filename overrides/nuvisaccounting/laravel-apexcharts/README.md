...
![Downloads](https://img.shields.io/packagist/dt/nuvisaccounting/laravel-apexcharts)
![Tests](https://img.shields.io/github/actions/workflow/status/nuvisaccounting/laravel-apexcharts/tests.yml?label=tests)
[![StyleCI](https://github.styleci.io/repos/452221855/shield?style=flat&branch=master)](https://styleci.io/repos/452221855)
[![License](https://img.shields.io/github/license/nuvisaccounting/laravel-apexcharts)](LICENSE.md)
...
Check out the [NuvisAccounting](https://github.com/nuvisaccounting/nuvisaccounting) project to see it live.
...
```bash
composer require nuvisaccounting/laravel-apexcharts
```
...
Please review [our security policy](https://github.com/nuvisaccounting/laravel-apexcharts/security/policy) on how to report security vulnerabilities.
