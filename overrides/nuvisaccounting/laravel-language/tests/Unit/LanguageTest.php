...
use NuvisAccounting\Language\Language;
...
class LanguageTest extends TestCase
{
    ...
    public function it_returns_package_flag_path_when_custom_not_exists()
    {
        ...
        $this->assertStringContainsString('vendor/nuvisaccounting/language', $path);
    }
    ...
    public function it_returns_custom_flag_path_when_exists()
    {
        ...
        $this->assertStringNotContainsString('nuvisaccounting/language', $path);
