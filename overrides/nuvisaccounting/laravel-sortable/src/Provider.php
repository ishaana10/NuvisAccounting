...
namespace NuvisAccounting\Sortable;

use NuvisAccounting\Sortable\View\Components\SortableLink;
    ...
    public function registerBladeDirectives()
    {
        $this->callAfterResolving('blade.compiler', function (BladeCompiler $compiler) {
            $compiler->directive('sortablelink', function ($expression) {
                ...
                return "<?php echo \NuvisAccounting\Sortable\Support\SortableLink::render(array ({$expression}));?>";
            });
        });
    }
