...
return [
    ...
    */
    'stubs' => [
        'enabled' => false,
        'path' => base_path() . '/vendor/nuvisaccounting/module/src/Commands/stubs',
        'files' => [
    ...
    */
    'composer' => [
        'vendor' => 'nuvisaccounting',
        'author' => [
            'name' => 'NuvisAccounting',
            'email' => 'info@nuvisaccounting.com',
        ],
    ],
    ...
    */
    ...
    |
    */
    'activator' => env('MODULE_ACTIVATOR', \NuvisAccounting\Module\Activators\File::class),
