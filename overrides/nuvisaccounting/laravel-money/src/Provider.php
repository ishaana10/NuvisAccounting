...
namespace NuvisAccounting\Money;
...
class Provider extends ServiceProvider
{
    ...
    {
        Blade::component('money', \NuvisAccounting\Money\View\Components\Money::class);
        Blade::component('currency', \NuvisAccounting\Money\View\Components\Currency::class);
    }
}
