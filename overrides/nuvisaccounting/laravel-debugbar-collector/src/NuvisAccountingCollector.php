...
class NuvisAccountingCollector extends DataCollector implements DataCollectorInterface, Renderable
{
    use Modules;
    ...
    public function collect()
    {
        ...
        $info = Info::all();
        $nuvisaccounting_version = ! empty($info['nuvisaccounting']) ? $info['nuvisaccounting'] : '0.0.0';
        ...
        return [
            'NuvisAccounting Version' => $nuvisaccounting_version,
