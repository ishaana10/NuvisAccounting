...
namespace NuvisAccounting\Module;
...
use NuvisAccounting\Module\Exceptions\InvalidAssetPath;
use NuvisAccounting\Module\Exceptions\ModuleNotFoundException;
use NuvisAccounting\Module\Process\Installer;
use NuvisAccounting\Module\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \NuvisAccounting\Module\Module
     */
     ...
     * @return string
     * @throws \NuvisAccounting\Module\Exceptions\ModuleNotFoundException
     */
